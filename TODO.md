...
### GDPR / Privacy
- [ ] Creare pagina `privacy.html` con informativa completa
- [ ] Creare pagina `cookie.html` con cookie policy
- [ ] Aggiungere link a privacy/cookie nel footer di tutte le pagine
- [ ] Aggiungere checkbox consenso GDPR obbligatorio sui form `iscrizioni.html` (entrambi)
- [ ] Aggiungere checkbox consenso GDPR sul form contatti `contatti.html`
- [ ] Verificare informativa newsletter e double-opt-in (nota in TODO se richiede backend)
- [ ] Aggiungere cookie banner conforme se introdotti analytics o cookie non tecnici

### Consistency check
- [ ] Verificare che tutti i link interni di nav e footer puntino a target esistenti
- [ ] Verificare che ogni img src nei .html corrisponda a un file reale
- [ ] Verifica conteggio "8 Docenti" annunciato vs reali su `docenti.html`
- [ ] Aggiungere foto Caterina Pentericci anche nel set duplicato (se si tiene quella cartella) oppure verificare consistenza unica
- [ ] Verifica che dopo il refactor i 7 CV PDF siano linkati o rimossi (no dead asset)

### QA finale
- [ ] Test apertura/chiusura modali docenti su tutti i 8 docenti (incluso ESC, click fuori, tasto Tab)
- [ ] Test responsive a 375px / 768px / 1024px / 1440px
- [ ] Test compilazione + submit di tutti i form
- [ ] Test navigazione tastiera (Tab) su tutta la home
- [ ] Lighthouse audit (Performance, Accessibility, SEO, Best Practices) — target ≥90 per ciascuno
- [ ] Validatore HTML W3C (no errori critici)
- [ ] Validatore CSS

### Documentazione
- [ ] Creare/aggiornare `README.md` con descrizione progetto, come servirlo localmente, deploy
- [ ] Creare `TECH_NOTES.md` con scelte tecniche e dependency
