...
3. [ ] **Configurare l'ID Formspree** sui 4 form (`iscrizioni.html` x2 + `contatti.html` x2). Account gratuito su https://formspree.io, poi `sed` come da `README.md` STEP 0 punto 3. *Nota: senza configurare, i form non inviano nulla — gli utenti useranno il fallback `mailto:centroprosopon@gmail.com` (Round 3) ma è regressione UX.*
